...
{ 	
  GPIO_InitTypeDef GPIO_InitStructure;
	...
	//Initialize GPIO with the specified parameters
	//根据设定参数初始化GPIO
  ...
  //允许修改RTC和后备寄存器
	...
	//Turn off the intrusion detection feature, known as PC13, which can also be used as normal IO
	//关闭入侵检测功能，也就是 PC13，也可以当普通IO 使用
