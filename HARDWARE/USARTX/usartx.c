...
{  	 
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOD, ENABLE);	 //Enable the gpio clock  //使能GPIO时钟
	RCC_APB1PeriphClockCmd(RCC_APB1Periph_USART2, ENABLE); //Enable the Usart clock //使能USART时钟
	GPIO_PinRemapConfig(GPIO_Remap_USART2, ENABLE);        //Pin remapping          //引脚重映射
